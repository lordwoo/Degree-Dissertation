...
<div id="main">
    ...
    <p>
        ...
        <a href="<c:url value="/pages/osteoporosis" />">basic information</a> about osteoporosis, directions for
        <a href="<c:url value="/pages/links" />">further information</a>, and a <a href="<c:url value="/pages/questionnaire" />">risk assessment tool</a> that will help
        you to assess whether or not you are likely to have developed the disease, and
        advise you on further action to take.
    </p>
</div> <!-- main -->